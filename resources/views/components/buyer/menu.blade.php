<nav class="sticky top-0 z-50 bg-white shadow border-b-2">
        ...
        <div class="flex h-16 justify-between">
            <div class="flex">
                ...
                <div class="flex items-center">
                    {{-- <img class="h-8 w-auto mr-2" src="{{ asset('logo-company.png') }}" alt="Pengajuan surat online"> --}}
                    <a href="{{ url('/') }}" class="text-sm lg:text-2xl font-semibold">Pengajuan Surat Online</a>
                </div>
            </div>
            <div class="flex items-center">
    ...
    <div class="transition-all duration-300 transform opacity-0 scale-95 hidden shadow-lg" id="mobile-menu">
        <div class="space-y-1 pb-3 pt-2">
            ...
            <a
                href="{{ route('masyarakat.pengajuan.pengajuanSaya') }}"class="block border-l-4 py-2 pl-3 pr-4 text-base font-semibold sm:pl-5 sm:pr-6 {{ request()->url() == route('masyarakat.pengajuan.pengajuanSaya') ? 'bg-indigo-50 border-indigo-500 font-bold text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700' }}">
                Riwayat Pengajuan
            </a>
        </div>
