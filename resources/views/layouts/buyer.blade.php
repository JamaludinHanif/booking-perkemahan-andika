...
<head>
    ...
    <title> Pengajuan surat online | {{ $title }}</title>
    ...
    <footer class="bg-gray-900">
        <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
            <div class="flex justify-center gap-x-6 md:order-2">
                <a href="https://www.instagram.com/liihhhhhh_" class="text-gray-400 hover:text-gray-300">
                ...
                <a href="https://wa.me/6289513195552" class="text-gray-400 hover:text-gray-300">
                    <span class="sr-only">WhatsApp</span>
                    <p class="flaticon-whatsapp"></p>
                </a>
            </div>
            <p class="mt-8 text-center text-sm/6 text-gray-400 md:order-1 md:mt-0">&copy; PT. Galih. All
                rights reserved.</p>
        </div>
    </footer>
